...
const Header = () => {
    ...
    return (
        <header className=" z-50 relative bg-[#0F1C3B]  flex items-center justify-between w-full h-25 mx-auto lg:px-10">
            <div>
                <img
                    src={Logo}
                    alt="Logo Dengoo"
            ...
            <nav className={`
                absolute bg-blue-100 right-10 top-28 p-7 z-0 bg-rose-primary rounded-xl duration-700 
