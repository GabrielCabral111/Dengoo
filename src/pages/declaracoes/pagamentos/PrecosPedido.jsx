...
export default function PedidoDeAmor() {
    ...
    <div className="min-h-screen bg-[linear-gradient(to_bottom,#4E1129_0%,#862C4E_50%,#750B34_100%)] flex items-center justify-center p-4">
      ...
      <div className="bg-[#c0a8c7] rounded-3xl p-6 max-w-4xl w-full text-white flex flex-col md:flex-row gap-6  items-center justify-center z-5">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-between">
          <div>
            <p className="text-sm text-red-900 mb-2">🔴 20 pessoas estão presenteando alguém neste momento!</p>
            ...
            <p className="text-2xl font-bold mb-4 text-black">R$ 89,99</p>
          ...
          <div className="flex gap-4 mt-6">
            <Link to="/declaracoes/pedido/galeria" className="mt-4 bg-[#1f1f1f] text-white px-6 py-2 rounded-full w-fit self-end hover:bg-[#111111] transition cursor-pointer">
                          Voltar
                        </Link>
            <Link to="/declaracoes/compra/pedidos" className="mt-4 bg-[#2D004D] text-white px-6 py-2 rounded-full w-fit self-end hover:bg-[#4A0070] transition cursor-pointer">
                          Avançar
                        </Link>
          </div>
        </div>
