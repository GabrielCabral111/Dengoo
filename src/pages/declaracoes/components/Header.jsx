...
const Header = () => {
    ...
    return (
        <header className="z-50 relative flex items-center justify-between max-w-[1400px] mx-auto lg:px-10">
            <div>
                <img
                    src={Logo}
                    alt="Logo Dengoo"
            ...
            <nav className={`
                absolute bg-[#C25881] text-[#fdfdfd] right-10 top-40 p-7 z-50 bg-rose-primary rounded-xl duration-700 
