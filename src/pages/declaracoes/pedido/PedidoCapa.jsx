...
export default function PedidoCapa() {
  const [titulo, setTitulo] = useState('Um pedido especial...');
      ...
      <div className="flex flex-col md:flex-row bg-[#f3e3ff] rounded-[40px] p-4 md:p-8 shadow-md w-full max-w-5xl gap-8">
        ...
        <div className="w-full md:w-1/2 px-0 md:px-8 flex flex-col justify-center gap-4">
          ...
          <div className="flex gap-4 mt-5">
            ...
            <Link to="/declaracoes/pedido/conteudo" className="mt-4 bg-[#2D004D] text-white px-6 py-2 rounded-full w-fit self-end hover:bg-[#4A0070] transition cursor-pointer">
              Avançar
            </Link>
          </div>
        </div>
